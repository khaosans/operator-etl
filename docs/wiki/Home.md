...
Source in git: https://github.com/khaosans/operator-etl/tree/master/docs
...
Success: **`OPERATOR_ETL_VERIFY=PASS`**, 76 tests, FOIA demo `silver=10` `quarantined=2`.
...
Paste this page from [`docs/wiki/Home.md`](https://github.com/khaosans/operator-etl/blob/master/docs/wiki/Home.md) into the GitHub Wiki tab if you keep that pointer in sync. See [RELEASING](https://github.com/khaosans/operator-etl/blob/master/docs/RELEASING.md#github-wiki-tab). Versions: [VERSIONING](https://khaosans.github.io/operator-etl/VERSIONING/).
