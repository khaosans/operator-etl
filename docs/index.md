...
Success ends with **`OPERATOR_ETL_VERIFY=PASS`**, 76 pytest, and a FOIA demo of `status=complete`, `silver=10`, `quarantined=2`.
...
| 76 pytest + SAST/SCA CI on every push | Live GCP / BigQuery end-to-end |
...
4. **Use** — [RUNNING](RUNNING.md) · [CLOUD-AGENT](CLOUD-AGENT.md) · [CLI](CLI.md) · [DASHBOARD](DASHBOARD.md) · [MCP](MCP.md) · [A2A](A2A.md) · [DISCORD](DISCORD.md) · [OBSERVABILITY](OBSERVABILITY.md) · [ADD-A-SOURCE](ADD-A-SOURCE.md) · [LLM](LLM.md)
...
7. **Contribute** — [CONTRIBUTING](https://github.com/khaosans/operator-etl/blob/master/CONTRIBUTING.md) · [REPO-HYGIENE](REPO-HYGIENE.md) · [BUILD-HYGIENE](BUILD-HYGIENE.md) · [VERSIONING](VERSIONING.md) · [RELEASING](RELEASING.md) · [SECURITY](https://github.com/khaosans/operator-etl/blob/master/SECURITY.md)
