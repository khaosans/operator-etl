...
**Proof:** `./scripts/verify.sh` → 51 pytest + FOIA demo `silver=10` `quarantined=2` `status=complete`. CI repeats that gate. Optional LLM is mocked in CI ([MODELS.md](MODELS.md), [LLM.md](LLM.md)).
