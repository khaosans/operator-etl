...
**Last updated:** 2026-09-03 · **Status:** MVP proven locally · **Gate:** `make e2e` (78 pytest + coverage)
...
**Exit criteria:**
- ✅ `make e2e` passes locally (78 pytest + coverage + FOIA demo)
...
- [x] 78 pytest + coverage fail_under=75
