...
cd operator-etl
git checkout v0.5.1   # after that tag exists
./scripts/verify.sh
```
...
```bash
pip install "operator-etl @ https://github.com/khaosans/operator-etl/releases/download/v0.5.1/operator_etl-0.5.1-py3-none-any.whl"
```

(Exact wheel filename follows PEP 440: `0.5.1`.)
